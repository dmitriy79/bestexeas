...
static unsigned char pchMessageStartTest[4] = { 0x7e, 0xbc, 0xe4, 0x1a };

// Public mainnet message start
static unsigned char pchMessageStartMain[4] = { 0xbc, 0xde, 0x4b, 0x9e };
